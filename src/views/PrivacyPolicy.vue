<template>
  ...
  <v-layout justify-center>
      <v-flex md6>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              Consortium", "We", "Us" or "Our" in this Agreement) refers to the
              DD-DeCaF Consortium.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              ...
              Consortium to facilitate the Service, to provide the Service on
              behalf of the Consortium, to perform services related to the
              Service or to assist the Consortium in analyzing how the Service
              is used.
            </p>
          </li>
          <li>
        ...
        <p>The Consortium may use Personal Data for the following purposes:</p>
        <ul>
          <li>
        ...
        <ul>
          <li>
            ...
            websites to You after You visited our Service or for p ayment
            processing.
          </li>
          <li>
        ...
        <p>
          The Consortium will retain Your Personal Data only for as long as is
        ...
        <p>
          The Consortium will take all steps reasonably necessary to ensure that
        ...
        <ul>
          ...
          <li>Protect and defend the rights or property of the Consortium</li>
          <li>
        ...
        <ul>
          <li>
            ...
            <p>
              ...
              browser, however please note that if you do this you may not have
              full functionality of this website. By using our websites, you
              acknowledge that Google may process data in the manner and for the
              purposes set out above. Please see further Google policies at:
              <a href="http://www.google.com/intl/en/policies/technologies/ads/"
        ...
        <p>
          ...
          any of them, please contact us using the contact email address below
          at any time. Your local laws (such as those in the EU) may permit you
          to request that we:
        </p>
        <ul>
          <li>
        ...
        <p>
          ...
          our legitimate interests or to comply with a legal obligation. We may
