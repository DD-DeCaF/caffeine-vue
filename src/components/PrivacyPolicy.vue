  ...
  <v-container>
    <v-layout justify-center>
      <v-flex md6>
        ...
        Technical University of Denmark is located at:
        <br />
        <address>
          Technical University of Denmark
          <br />DTU Biosustain Building 220, Kemitorvet, Lyngby <br />2800 -
          Denmark , Denmark <br />21798922
        </address>

        <p>
          It is Technical University of Denmark's policy to respect your privacy
          regarding any information we may collect while operating our website.
          This Privacy Policy applies to
          <a href="https://caffeine.dd-decaf.eu"
            >https://caffeine.dd-decaf.eu</a
          >
          (hereinafter, "us", "we", or "https://caffeine.dd-decaf.eu"). We
        ...
        <p>
          Like most website operators, Technical University of Denmark collects
          non-personally-identifying information of the sort that web browsers
          and servers typically make available, such as the browser type,
          language preference, referring site, and the date and time of each
          visitor request. Technical University of Denmark's purpose in
          collecting non-personally identifying information is to better
          understand how Technical University of Denmark's visitors use its
          website. From time to time, Technical University of Denmark may
        ...
        <p>
          Technical University of Denmark also collects potentially
          ...
          https://caffeine.dd-decaf.eu blog posts. Technical University of
          Denmark only discloses logged in user and commenter IP addresses under
        ...
        <p>
          Certain visitors to Technical University of Denmark's websites choose
          to interact with Technical University of Denmark in ways that require
          Technical University of Denmark to gather personally-identifying
          information. The amount and type of information that Technical
          University of Denmark gathers depends on the nature of the
          interaction. For example, we ask visitors who sign up for a blog at
          https://caffeine.dd-decaf.eu to provide a username and email address.
        </p>
        ...
        <p>
          ...
          Technical University of Denmark and does not cover the use of cookies
          by any advertisers.
        </p>
        ...
        <p>
          Technical University of Denmark may collect statistics about the
          behavior of visitors to its website. Technical University of Denmark
          may display this information publicly or provide it to others.
          However, Technical University of Denmark does not disclose your
          personally-identifying information.
        </p>

        <h2>Cookies</h2>
        <p>
          To enrich and perfect your online experience, Technical University of
          Denmark uses "Cookies", similar technologies and services provided by
        ...
        <p>
          ...
          website each time the visitor returns. Technical University of Denmark
          uses cookies to help Technical University of Denmark identify and
          track visitors, their usage of https://caffeine.dd-decaf.eu, and their
          website access preferences. Technical University of Denmark visitors
          who do not wish to have cookies placed on their computers should set
          their browsers to refuse cookies before using Technical University of
          Denmark's websites, with the drawback that certain features of
          Technical University of Denmark's websites may not function properly
          without the aid of cookies.
        </p>
        <p>
          By continuing to navigate our website without changing your cookie
          settings, you hereby acknowledge and agree to Technical University of
          Denmark's use of cookies.
        </p>

        <h2>Privacy Policy Changes</h2>
        <p>
          Although most changes are likely to be minor, Technical University of
          Denmark may change its Privacy Policy from time to time, and in
          Technical University of Denmark's sole discretion. Technical
          University of Denmark encourages visitors to frequently check this
        ...
        <p>
          ...
          us via <a href="mailto:niso@biosustain.dtu.dk">email</a> or
